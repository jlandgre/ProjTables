#Version 4/18/23 - Updated for projtables.ProjectTables instance and its inputs
...
class Files():
    ...
    * self.path_subdir_xxx is a folder name or directory path suffix
    ...
    def SetGenericProjectPaths(self):
        ...
        self.path_scripts = self.lstpaths[0]
        self.path_tests = self.path_root + 'tests' + os.sep
        self.path_data = self.lstpaths[1] + self.proj_abbrev + '_data' + os.sep
